...
// QString idcard = obj["idcard"].isString() ? obj["idcard"].toString() :
// QString::number(obj["idcard"].toVariant().toLongLong()); QString telephone =
// obj["telephone"].isString() ? obj["telephone"].toString() :
// QString::number(obj["telephone"].toVariant().toLongLong()); QString address =
// obj["address"].toString(); QString avatar = obj["avatar"].toString(); QString
// passwd = obj["passwd"].toString(); QString establishDay =
// obj["establishDay"].toString(); QString birthday =
// obj["birthday"].toString(); qDebug() << name << idcard << telephone <<
// address << avatar << passwd << establishDay << birthday;