...
bool Init_State_3() {
  QJsonObject json;
  json.insert("feature", RSA::encryptQ(globalsecurity::FEATURE,
                                       globalsecurity::SERVER_RSA_PUBLIC));
  json.insert("pubkey", RSA::encryptQ(globalsecurity::LOCAL_RSA_PUBLIC,
                                      globalsecurity::SERVER_RSA_PUBLIC));
  json.insert("aesp", RSA::encryptQ(globalsecurity::AES_KEY,
                                    globalsecurity::SERVER_RSA_PUBLIC));
  ...
  QObject::connect(net, &TcpNetUtils::requestFinished, [=]() {
    ...
    globalsecurity::AES_KEY =
        QCryptographicHash::hash(_key3.toUtf8(), QCryptographicHash::Md5)
            .toHex();
